...
angular.module('app')
    .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', '$http', '$cookieStore', 'blockUI', '$state', 'SERVICE_CONFIG',
    function($scope, $translate, $localStorage, $window, $http, $cookieStore, blockUI, $state, SERVICE_CONFIG) {
