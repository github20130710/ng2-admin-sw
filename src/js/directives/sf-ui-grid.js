    ...
    angular.module('sf.ui.grid', ['ui.grid', 'ui.grid.selection', 'ui.grid.edit', 'ui.grid.pagination', 'ui.grid.resizeColumns', 'ui.grid.autoResize'])
        .directive('sfUiGrid', function(i18nService){
            return {
                ...
                template: '<div ui-grid="gridOptions" ng-style="height" ui-grid-pagination ui-grid-selection ui-grid-resize-columns ui-grid-auto-resize></div>',
                link: function(scope, elem, attrs){

                    i18nService.setCurrentLang("zh-cn");

                    scope.height = {'height': (document.body.clientHeight - 155)+'px'};
